...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='EvyWIwqI8eRhrqOYB7X1.F0ABpLeoRsEKFrgjk8Jvaq.cnYwrSDnUeVgtGIar/krlFb7v4z0yLqSq6hmGXOXKy8=')
vipro.loginResult()
...
╚═════════════════════════
"""
vip="u7f469b3e510ead27a47d11892bc8d501"
...
Bots=[mid]
Creator=["u7f469b3e510ead27a47d11892bc8d501"]
admin=["u7f469b3e510ead27a47d11892bc8d501"]
...
#                            Name = summon(op.param2)
		...
		if msg.from_ in admin:
		    ...
		    vipro.sendText(msg.to,"Khusus Admin")
                ...
                wait["Sider"] = True
                vipro.sendText(msg.to,"Siap On Cek Tikungan")
